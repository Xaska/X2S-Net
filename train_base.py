...
from utils1 import MyDataSet
from model.ConvNeXT_DCA_FB_Edge import FeatureNet as create_model
from utils1 import read_train_data, read_val_data, train_one_epoch, evaluate
...
def main(args):
    ...
    train_images1_path, train_images2_path, train_images1_label, train_images2_label, train_3d_label \
    ...
    train_dataset = MyDataSet(images1_path=train_images1_path,
    ...
    val_dataset = MyDataSet(images1_path=val_images1_path,
    ...
    if args.RESUME :
        path_checkpoint = "./model_weight/best_model.pth"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data_path', type=str, default="../3D_dataset/train")
    parser.add_argument('--val_data_path', type=str, default="../3D_dataset/validation")
