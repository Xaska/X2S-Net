...
# from model.model_1_x1_1 import FeatureNet as create_model
from model.ConvNeXt_DCA_FB import FeatureNet as create_model
from utils import read_train_data, create_lr_scheduler, get_params_groups, train_one_epoch
from utils1 import MyDataSet, MyDataSet1, data_test, read_val_data, evaluate_x1_1

def main():
    file = "test"
    # load model weights
    model_weight_path = "../train/model_weight_x1_2/best_model.pth"
    ...
    test_loss, SAC = evaluate_x1_1(model=model,
