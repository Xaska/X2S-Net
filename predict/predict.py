...
from utils1 import MyDataSet, MyDataSet1, data_test, read_val_data, evaluate_normal

def main():
    file = "test"
    # load model weights
    model_weight_path = "../train/model_weight_Edge/best_model.pth"
    ...
    test_loss, SAC = evaluate_normal(model=model,
